...
var send = function send(action, dispatch, config, isOfflineToOnline) {
  ...
  if ((offlineAction.type === "OUTBOUND_ROOM_MODEL_UPDATE" || offlineAction.type === "OUTBOUND_TASK_CREATE" || offlineAction.type === "OUTBOUND_TASK_REASSIGN")  && isOfflineToOnline) {
    setTimeout(() => {
